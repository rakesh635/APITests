Feature: Testing all the product rest APIs
  ...
  Scenario: Get the full product list
		Given url 'http://10.62.125.9:8091/product/list'
		When method GET
		Then status 200
  ...
  Scenario: Add a new product to the list
		Given url 'http://10.62.125.9:8091/product/add'
 ...
 # Scenario: Delete the 3rd product from the product list
		#Given url 'http://10.62.125.9:8091/product/delete/3'
		#When method DELETE
		#Then status 200
  ...
  Scenario: Update the price of the first product in the list
		Given url 'http://10.62.125.9:8091/product/update/1'
